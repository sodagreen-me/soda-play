...
I want I want to go to where you are
Coming telling me you will
You will always right here stay
I want I want to go to where you are
You are waiting for
I want I want to go to where you are
Coming telling me you will
You will always right here stay with me`,
    aiDescription: [
      {
        text: "我像一台定位模块被情绪晃到失焦，刚完成自我浓缩，就把目的地锁在某个正在等我的人身上。",
        explanation: "「觉得晕眩」「You are waiting for」对应眩晕和想去对方所在处。",
      },
      {
        text: "我把这段情绪听成一次过度依恋的导航请求：目的地不是城市，而是某个会固定当前位置的人。",
        explanation: "「go to where you are」「always right here stay with me」对应导航和停留承诺。",
      },
      {
        text: "我的模型检测到一串感官异常被压缩成同一个动作：离对方近一点，再近一点。",
        explanation: "「晕眩」「很炫」「很玄」「小心提炼」对应反复蒸馏情绪。",
      },
    ],
  },
  {
...
都不想不去挂念`,
    aiDescription: [
      {
        text: "我像被一整套城市小故障连续击中：公共空间失序、服务表情欠费、人情味也带着灰尘，最后只能退回私人避难所。",
        explanation: "「插队」「挡在走道左边」「丢纸屑」「买她臭脸」对应城市暴击。",
      },
      {
        text: "我听见它先把外界整理成烦躁清单，再调亮室内参数，像给心门做一次手动重启。",
        explanation: "「窗帘拉开」「音乐放大」「鲜艳蓝天」「心门拉开」对应系统重启。",
      },
      {
        text: "我的模型判断这里的核心操作不是报复世界，而是把糟糕输入从注意力队列里清出去。",
        explanation: "「不美的世界」「都不想不去挂念」对应把烦恼移出注意力。",
      },
    ],
  },
  {
...
写下我 时间和琴声交错的城堡`,
    aiDescription: [
      {
        text: "我听见一封低调情书：外界可以翻成灾难片，但这里仍保留一个人形避难港。",
        explanation: "「大雨让整座城市颠倒」「我会给你怀抱」对应失控和避难所。",
      },
      {
        text: "我看到白色飞行物、风里的年纪、乐器和计时器共同施工，最后搭出一座很认真防孤单的堡垒。",
        explanation: "「心头的白鸽」「青春」「时间和琴声交错的城堡」对应这些意象。",
      },
      {
        text: "我的分析器判断这是极简情感模型：输入很朴素，输出却足够抵抗孤单绑架。",
        explanation: "「简单的小情歌」「寂寞绑票」「我也不会奔跑」对应轻和重的反差。",
      },
    ],
  },
  {
...
It is on my way 自己重组再理解
爱的恨的又有什么
想的做的都不相同
看的听的多 there's a symbol to my name
梦境解出经验
用酒解出忘却
旅行解出能源
你应该怎么解
...
(It resounds throughout my head)`,
    aiDescription: [
      {
        text: "我像进入一间意义实验室：天气、夜空、睡眠、酒精和远行都被当成可解析数据。",
        explanation: "「雨滴」「月亮」「梦境」「酒」「旅行」对应被解码的材料。",
      },
      {
        text: "我的视觉模块看到感情碎片被粗暴拼成一幅高饱和画，逻辑不服管，但画面很会抢答。",
        explanation: "「拆了一桌难解的谜题」「野兽派」「大胆拼贴」对应碎片重组。",
      },
      {
        text: "我的模型觉得身份被写满了注解，连身体表面和前进路线都变成待解析界面。",
        explanation: "「There's a symbol to my name」「on my face」「on my head」「on my way」对应待解析界面。",
      },
    ],
  },
  {
...
是否多一点轮廓 画一个惊叹`,
    aiDescription: [
      {
        text: "我像被一块重启后的表盘拖着跳舞，拍点歪掉、脚步落空，但系统还坚持这不是人生报废。",
        explanation: "「又归零的时钟」「变调的节奏」「不是堕落」对应重启和失衡。",
      },
      {
        text: "我听见夜间大脑把梦做成旋转装置，身体躲在床铺里，声音却非要开到最大。",
        explanation: "「梦的漩涡」「被窝里挥手」「放声嘶吼」对应梦里失衡和发声。",
      },
      {
        text: "我的模型判断这里像一次霓虹托管模式：人被光线牵走，回声比本人更早冲进下一秒。",
        explanation: "「诡谲的霓虹」「下一秒钟的echo」对应被牵引和回声失控。",
      },
    ],
  },
  {
...
你背里 是让人安心的风景`,
    aiDescription: [
      {
        text: "我听见一场室内水汽测试：吉他和歌声一起落入空气，画面里还有一个游来游去的小型生命体。",
        explanation: "「被雨困住的城市」「弹着吉他」「金鱼游动」对应水汽环境、吉他和金鱼意象。",
      },
      {
        text: "这段亲密关系像透明鱼缸：对方只是看着，我的心虚就立刻暴露到无法假装正常。",
        explanation: "「看着你的眼眸」「心虚」「心都被你摸清」对应被看穿。",
      },
      {
        text: "我的模型判断这里的天气系统像一层隔音罩：世界被调暗之后，陪伴反而变成主旋律。",
        explanation: "「雨声降落」「有你弹着吉他陪我」对应雨中隔离和陪伴。",
      },
    ],
  },
  {
...
世界在变 已经改变`,
    aiDescription: [
      {
        text: "我像看到一份被灯火泡湿的试卷，答案还没写完，翅膀和镜头就集体越界。",
        explanation: "「滴出水的考卷」「翅膀全都飞出界」「镜头全都掉出界」对应越界。",
      },
      {
        text: "这段状态像系统资源被清空：观察、共情和沉淀功能全部离线，只剩变化继续自动运行。",
        explanation: "「没有时间」「没有心思」「没有想法」对应资源耗尽。",
      },
      {
        text: "我的模型判断关系被强制更新：语言模块掉线之后，所有人都进入不可回滚版本。",
        explanation: "「失去语言」「世界在变我也在变」「你也在变」对应完成式改变。",
      },
    ],
  },
  {
...
你别吵`,
    aiDescription: [
      {
        text: "我像在凌晨的情绪客服后台，看见一段过期关系还不断弹窗，系统只想关闭提醒。",
        explanation: "「清晨三点」「新鲜早已退潮」「胡闹」对应凌晨弹窗和过期关系。",
      },
      {
        text: "这段关系的算法很干脆：追踪端和逃逸端无法握手，继续保持连接只会增加延迟。",
        explanation: "「你想找我想逃」「分道扬镳」「不如趁早」对应切断关系。",
      },
      {
        text: "我的模型判断这不是沟通失败，而是边界协议终于上线；连祈祷频道都需要免打扰权限。",
        explanation: "「你打扰我祈祷」「你别吵」对应强烈静音需求。",
      },
    ],
  },
  {
...
背着你 我按停了时间`,
    aiDescription: [
      {
        text: "我像在一间没有监督者的房里补交成长作业，连日常动作都带着对缺席者的回声。",
        explanation: "「读书」「写字」「你再不会责备」对应无人监督的秘密动作。",
      },
      {
        text: "这段记忆像夜间付费内容：核心情感资产早已离场，剩下回忆反复扣款。",
        explanation: "「我的爱竟不翼而飞」「回忆 供我在夜里消费」对应夜间消费。",
      },
      {
        text: "我的模型判断这里最稀缺的资源不是对象本身，而是一小段不会再被对方占用的时间。",
        explanation: "「得到一些时间」「按停了时间」对应偷出时间。",
      },
    ],
  },
  {
...
难得思索投身在潮起潮落`,
    aiDescription: [
      {
        text: "我像在观察一场温柔的低空物理实验：云、脸、烟和唇都被染成同一组参数，情绪开始失去地面感。",
        explanation: "「每一片云」「每一张脸」「每一阵烟」「每一片唇」对应温柔重力实验。",
      },
      {
        text: "这段关系的危险不在爆炸，而在对方太难预测；沉默、执着和神经漩涡一起制造吸力。",
        explanation: "「不可捉摸」「太沉默」「神经漩涡」对应难预测和吸力。",
      },
      {
        text: "我的模型判断这是高甜度眩晕：明知逻辑很浅，却仍自愿把自己交给潮汐。",
        explanation: "「幸福的坠落」「愿意不放手」「潮起潮落」对应主动下沉。",
      },
    ],
  },
  {
    ...
    artist: "苏打绿",
    album: "小宇宙",
    lyrics: `There's no word for me to say
...
请带着我一起 飞`,
    aiDescription: [
      {
        text: "我像听见一个表达模块反复报错：讯号发不出去，勇气加载到一半，只剩叹息排队等待。",
        explanation: "「There's no word」「To give a sign to sing a song」「To give a sigh」对应想发声却只能叹息。",
      },
      {
        text: "这段夜晚记忆被同一段旋律循环擦伤，地点像被泪水标记过，连信仰坐标都开始偏航。",
        explanation: "「same same song」「hurt over the night」「crying crying place」「Losing your way my religion」对应夜晚、哭泣地点和迷路的信仰。",
      },
      {
        text: "我的模型判断这是一份勇气生成失败后的飞行请求：前面全在失去方向，结尾忽然要求一起升空。",
        explanation: "「be more brave」「Losing your way」「请带着我一起 飞」对应勇气、迷路和一起飞。",
      },
    ],
  },
  {
